    ...
    function SettingsMenu () {
        return (
          <>
            ...
            <button className="btn mx-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#settingsMenu" aria-controls="settingsMenu">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-gear-fill text-white" viewBox="0 0 16 16">
